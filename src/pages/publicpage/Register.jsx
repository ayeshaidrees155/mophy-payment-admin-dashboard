        ...
        >
            ...
            <Box className="w-full md:w-1/2 flex items-center justify-center h-full overflow-y-auto py-2">
                <Box className="w-full max-w-md px-3 sm:px-0 mx-auto">
                    ...
                    <Divider sx={{ mb: 2, color: "black", fontSize: "var(--text-body)" }}>Register</Divider>
                    ...
                    <Button
                        ...
                        sx={{ height: 42, borderRadius: 2, backgroundColor: "var(--blue-clr)", color: "var(--bg-header)", textTransform: "none", fontSize: "var(--text-body)", marginBottom: 1.5 }}
                    >
                        Sign Me Up
                    </Button>
                </Box>
