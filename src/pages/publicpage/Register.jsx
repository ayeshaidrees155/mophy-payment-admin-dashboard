            ...
            <Box className="w-full md:w-1/2 flex items-center justify-center py-6 md:py-0">
                <Box className="w-full max-w-md px-4 sm:px-0 mx-auto">
                    ...
                    <Typography sx={{ color: "var(--gray-clr)", textAlign: "center", mb: 3, fontSize: "var(--text-body)" }}>
                        Register page allows users to enter login credentials for authentication and access to secure content.
                    </Typography>

                    <Divider sx={{ mb: 3, color: "black", fontSize: "var(--text-body)" }}>Register</Divider>
                    ...
                    <Box className="flex flex-col sm:flex-row gap-4 mb-5">
                        ...
                        <Button
                            ...
                            sx={{ height: 50, borderRadius: 2, textTransform: "none", color: "var(--gray-clr)", borderColor: "black", background: "white" }}
                        >
                            Sign in with Apple
                        </Button>
                    </Box>
                    ...
                    <Box className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 mb-4">
                        ...
                        <Typography
                            ...
                            component="a"
                            href=""
                            sx={{ color: "var(--blue-clr)", textDecoration: "none", fontSize: "var(--text-title)" }}
                        >
                            Sign in
                        </Typography>
                    </Box>
                    ...
                    <Button
                        ...
                        variant="contained"
                        onClick={handleLogin}
                        sx={{ height: 50, borderRadius: 2, backgroundColor: "var(--blue-clr)", color: "var(--bg-header)", textTransform: "none", fontSize: 16, marginBottom: 3 }}
                    >
                        Sign Me Up
                    </Button>
                </Box>
